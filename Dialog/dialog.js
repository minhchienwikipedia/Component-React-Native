...
class dialog extends Component {
    ...
    renderDialogWithoutBtns() {
        return (
            <Dialog ref='dialog0' title = "" style={{justifyContent: 'center', marginTop: 50}}>
                <View style={styles.dialogConatiner}>
                <TouchableOpacity style={styles.buttontouch}><Text>Button 1</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.buttontouch}><Text>Button 2</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.buttontouch}><Text>Button 3</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.buttontouch}><Text>Button 3</Text>
                </TouchableOpacity>
                </View>
    ...
    renderDialogCustomStyle(){
        return (
            ...
            <Dialog
                ...
                ref='dialog3'>
                <View style={styles.dialogConatiner}>
                    <Text>This is custom style</Text>
                </View>
            </Dialog>
        );
    }
